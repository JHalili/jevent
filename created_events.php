...
<html lang="en">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-1">
                <span class="label label-default" contenteditable="false">Created</span>
            </div>
            <div class="col-md-10">
                <?php
                $query = "SELECT * from Event E, Event_Created EC WHERE E.id = EC.event_Id AND '$username' = user_username";
